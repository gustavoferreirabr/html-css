...
const ps = paragrafosDiv.querySelectorAll('p');

const estiloBody = getComputedStyle(document.body);
const valorBackground = estiloBody.backgroundColor;
console.log(valorBackground);

for(let indice of ps){

    indice.style.backgroundColor = valorBackground;
    indice.style.color = '#FFFFFF'
